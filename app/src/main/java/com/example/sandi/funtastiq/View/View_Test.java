...
import com.example.sandi.funtastiq.Have_Winner;
...
public class View_Test extends AppCompatActivity {
    ...
    TextView idview,tvisi1,tvisi2,tvisi3,tvtittle,iv_close;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (itittle==null) {
            if (CGT.getEtittle().equals("")){
                ...
                tvtittle.setText(CGT.getEtittle());
                tvisi1.setText(CGT.getEisi_pertama());
                tvisi2.setText(CGT.getEisi_kedua());
                tvisi3.setText(CGT.getEisi_ketiga());
        ...
        mission.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), MissionDefine.class);
                startActivity(i);
                finish();
            }
        });
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (tvtittle.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(), "Data Anda Masih Kosing", Toast.LENGTH_LONG).show();
                } else if (tvisi1.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(), "Data Anda Masih Kosing", Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(getApplicationContext(), Have_Winner.class);
                    startActivity(i);
                    finish();
                }
            }
    ...
    public void uploadData(){
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(View_Test.this,"Upload","Data dikirim....",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")){
                    new AlertDialog.Builder(View_Test.this)
                    ...
                    Toast.makeText(View_Test.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
