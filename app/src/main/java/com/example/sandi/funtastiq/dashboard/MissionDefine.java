...
public class MissionDefine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mission_define);
        ...
        ivmisentry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MissionDefine.this,define.class);
                startActivity(i);
                finish();
                //getData();
            }
        ...
        ivmispreview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MissionDefine.this,View_Define.class);
                //getData();
                startActivity(i);
                finish();
            }
        ...
        ivmisplace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MissionDefine.this, MapsActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent i = new Intent(MissionDefine.this, MainActivity.class);
                        startActivity(i);
                        finish();
                    }
