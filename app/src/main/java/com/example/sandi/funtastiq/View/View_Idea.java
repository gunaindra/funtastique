...
import com.example.sandi.funtastiq.Dashboard;
...
public class View_Idea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view__idea);
        ...
        if (itittle==null) {
            if (CGI.getEtittle().equals("")){
                ...
                tvtittle.setText(CGI.getEtittle());
                tvisi1.setText(CGI.getEisi_pertama());
                tvisi2.setText(CGI.getEisi_kedua());
                tvisi3.setText(CGI.getEisi_ketiga());
        ...
        entry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),idea.class);
        ...
        mission.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), MissionIdea.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void uploadData(){
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(View_Idea.this,"Upload","Data dikirim....",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")){
                    new AlertDialog.Builder(View_Idea.this)
                    ...
                    Toast.makeText(View_Idea.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
