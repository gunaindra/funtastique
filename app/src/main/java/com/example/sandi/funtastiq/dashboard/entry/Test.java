...
import com.example.sandi.funtastiq.View.View_Prototyping;
...
public class Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null!=itittle){
            ...
            if (CGT.getEtittle().equals("")) {
                ...
                tittle.setText(CGT.getEtittle());
                isi1.setText(CGT.getEisi_pertama());
                isi2.setText(CGT.getEisi_kedua());
                isi3.setText(CGT.getEisi_ketiga());
                if (!CGT.getEgambar_satu().equals("")) {
                    String image_url1 = CGT.getEgambar_satu();
                    ImageLoader imgLoader1 = new ImageLoader(getApplicationContext());
                    imgLoader1.DisplayImage(image_url1, loader, mIv1);
                }
                if (!CGT.getEgambar_dua().equals("")) {
                    String image_url2 = CGT.getEgambar_dua();
                    ImageLoader imgLoader2 = new ImageLoader(getApplicationContext());
                    imgLoader2.DisplayImage(image_url2, loader, mIv2);
                }
                if (!CGT.getEgambar_tiga().equals("")) {
                    String image_url3 = CGT.getEgambar_tiga();
        ...
        ivcam1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,Test.this)){
                        openCameraApp();
                    }else{
                        requestPermission(Test.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                        openCameraApp();
                    }
                }else{
                    openCameraApp();
        ...
        misentry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Test.this,MissionTest.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mivpreem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tittle.getText().toString().trim().equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(), View_Test.class);
    ...
    public void uploadData(){
        ...
        final String katagori = User+"Test";
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Test.this,"Upload","Data dikirim....",false,false);
            }
    ...
    private Uri getImageUri(Test youractivity, Bitmap bitmap) {
