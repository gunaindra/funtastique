...
public class Class_Get_Proto {
    private static Class_Get_Proto instance;
    ...
    public static synchronized Class_Get_Proto getInstance(){
        if (instance == null){
            instance=new Class_Get_Proto();
        }
        return instance;
    }
}
