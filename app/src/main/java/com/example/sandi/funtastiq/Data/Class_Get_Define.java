...
public class Class_Get_Define {
    private static Class_Get_Define instance;
    ...
    public static synchronized Class_Get_Define getInstance(){
        if (instance == null){
            instance=new Class_Get_Define();
        }
        return instance;
    }
}
