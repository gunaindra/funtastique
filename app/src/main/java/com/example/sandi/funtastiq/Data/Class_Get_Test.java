...
public class Class_Get_Test {
    private static Class_Get_Test instance;
    ...
    public static synchronized Class_Get_Test getInstance(){
        if (instance == null){
            instance=new Class_Get_Test();
        }
        return instance;
    }
}
