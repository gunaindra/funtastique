...
public class Prototyping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null!=itittle){
            ...
            if (CGP.getEtittle().equals("")) {
                ...
                tittle.setText(CGP.getEtittle());
                isi1.setText(CGP.getEisi_pertama());
                isi2.setText(CGP.getEisi_kedua());
                isi3.setText(CGP.getEisi_ketiga());
        ...
        ivcam1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,getApplicationContext())){
                        openCameraApp();
                    }else{
                        requestPermission(Prototyping.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                        openCameraApp();
                    }
                }else{
                    openCameraApp();
        ...
        misentry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Prototyping.this,MissionProto.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mivpreem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tittle.getText().toString().trim().equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(), View_Prototyping.class);
    ...
    public void uploadData(){
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")) {
                    new AlertDialog.Builder(Prototyping.this)
                    ...
                    Toast.makeText(Prototyping.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
            ...
            if (resultCode == RESULT_OK) {
                if (data.hasExtra("data")) {
                    if (null==mIv1.getDrawable()) {
                        ...
                        uri = getImageUri(Prototyping.this, img1);
                        File finalFile = new File(getRealPathFromUri(uri));
                        mIv1.setImageBitmap(img1);
                    }else if (null==mIv2.getDrawable()) {
                        img2 = (Bitmap) data.getExtras().get("data");
                        uri = getImageUri(Prototyping.this, img2);
                        File finalFile = new File(getRealPathFromUri(uri));
                        mIv2.setImageBitmap(img2);
    ...
    private Uri getImageUri(Prototyping youractivity, Bitmap bitmap) {
