...
public class MissionProto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mission_proto);
        ...
        ivmisentry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MissionProto.this,Prototyping.class);
                startActivity(i);
                finish();
                //getData();
            }
        ...
        ivmispreview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MissionProto.this,View_Prototyping.class);
                //getData();
                startActivity(i);
                finish();
            }
        ...
        ivmisplace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MissionProto.this, MapsActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent i = new Intent(MissionProto.this, MainActivity.class);
                        startActivity(i);
                        finish();
                    }
