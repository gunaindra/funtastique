...
public class Class_Get_Empati {
    private static Class_Get_Empati instance;
    ...
    public static synchronized Class_Get_Empati getInstance(){
        if (instance == null){
            instance=new Class_Get_Empati();
        }
        return instance;
    }
}
