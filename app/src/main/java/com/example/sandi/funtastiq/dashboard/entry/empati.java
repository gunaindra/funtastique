...
public class empati extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empati);
        ...
        if (null!=itittle){
            ...
            if (CGE.getEtittle().equals("")) {
                ...
                tittle.setText(CGE.getEtittle());
                isi1.setText(CGE.getEisi_pertama());
                isi2.setText(CGE.getEisi_kedua());
                isi3.setText(CGE.getEisi_ketiga());
        ...
        ivgal1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(empati.this, AlbumSelectActivity.class);
        ...
        ivcam1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,empati.this)){
                        openCameraApp();
                    }else{
                        requestPermission(empati.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                        openCameraApp();
                    }
                }else{
                    openCameraApp();
        ...
        misentry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(empati.this,MissionEmpaty.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mivpreem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tittle.getText().toString().trim().equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(), View_Empati.class);
        ...
        dash = (TextView)findViewById(R.id.tv_dash);
    ...
    public void uploadData(){
        ...
        class uploadData extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(empati.this,"Upload","Data dikirim....",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")){
                    new AlertDialog.Builder(empati.this)
                    ...
                    Toast.makeText(empati.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
    ...
    private Uri getImageUri(empati youractivity, Bitmap bitmap) {
