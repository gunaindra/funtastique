...
public class View_Define extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view__define);
        ...
        if (itittle==null) {
            if (CGD.getEtittle().equals("")){
                ...
                tvtittle.setText(CGD.getEtittle());
                tvisi1.setText(CGD.getEisi_pertama());
                tvisi2.setText(CGD.getEisi_kedua());
                tvisi3.setText(CGD.getEisi_ketiga());
        ...
        entry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),define.class);
    ...
    public void uploadData(){
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(View_Define.this,"Upload","Data dikirim....",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")){
                    new AlertDialog.Builder(View_Define.this)
                    ...
                    Toast.makeText(View_Define.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
