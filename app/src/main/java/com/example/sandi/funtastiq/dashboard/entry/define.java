...
public class define extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null!=itittle){
            ...
            if (CGD.getEtittle().equals("")) {
                ...
                tittle.setText(CGD.getEtittle());
                isi1.setText(CGD.getEisi_pertama());
                isi2.setText(CGD.getEisi_kedua());
                isi3.setText(CGD.getEisi_ketiga());
                if (!CGD.getEgambar_satu().equals("")) {
                    String image_url1 = CGD.getEgambar_satu();
                    ImageLoader imgLoader1 = new ImageLoader(getApplicationContext());
                    imgLoader1.DisplayImage(image_url1, loader, mIv1);
                }
                if (!CGD.getEgambar_dua().equals("")) {
                    String image_url2 = CGD.getEgambar_dua();
                    ImageLoader imgLoader2 = new ImageLoader(getApplicationContext());
                    imgLoader2.DisplayImage(image_url2, loader, mIv2);
                }
                if (!CGD.getEgambar_tiga().equals("")) {
                    String image_url3 = CGD.getEgambar_tiga();
        ...
        ivgal1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(define.this, AlbumSelectActivity.class);
        ...
        ivcam1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,define.this)){
                        openCameraApp();
                    }else{
                        requestPermission(define.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                        openCameraApp();
                    }
                }else{
                    openCameraApp();
        ...
        misentry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(define.this,MissionDefine.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mivpreem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tittle.getText().toString().trim().equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(), View_Define.class);
    ...
    public void uploadData(){
        ...
        final String katagori = User+"Define";
        ...
        class uploadData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(define.this,"Upload","Data dikirim....",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (s.equals("")){
                    new AlertDialog.Builder(define.this)
                    ...
                    Toast.makeText(define.this,s,Toast.LENGTH_LONG).show();
                    int idk = 1;
    ...
    private Uri getImageUri(define youractivity, Bitmap bitmap) {
